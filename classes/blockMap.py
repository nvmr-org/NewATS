...
class BlockMap(object):
    ...
    def dump(self):
        print '*****************'
        print 'max Block Address'
        print '*****************'
        m =  max(self, key=lambda x: x.address)
        print 'Max Block address = ', m.address
        m = max(self, key=lambda x: x.segment)
        print 'Total Segments = ', m.segment
        #layoutLength = len(blockMap)
        #layoutLength = blockMap.size()
        print 'Total Blocks = ' , self.size()
